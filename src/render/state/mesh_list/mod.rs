...
impl MeshList {
    pub fn new() -> MeshList {
        ...
        let vertices: Vec<Colored_Mesh_Vertex> = vec![
            Colored_Mesh_Vertex { pos: (-20.0, -0.5, -20.0).into(), clr: (1.0, 1.0, 0.0).into() },
            Colored_Mesh_Vertex { pos: ( 20.0, -0.5,  20.0).into(), clr: (0.0, 0.0, 0.0).into() },
            Colored_Mesh_Vertex { pos: ( 20.0, -0.5, -20.0).into(), clr: (0.0, 1.0, 0.0).into() },
            Colored_Mesh_Vertex { pos: ( 20.0, -0.5,  20.0).into(), clr: (0.0, 0.0, 0.0).into() },
            Colored_Mesh_Vertex { pos: (-20.0, -0.5, -20.0).into(), clr: (1.0, 1.0, 0.0).into() },
            Colored_Mesh_Vertex { pos: (-20.0, -0.5,  20.0).into(), clr: (1.0, 1.0, 0.0).into() },
        ];
        let ground_plane = ColoredMesh::from_vec(&vertices).unwrap();
